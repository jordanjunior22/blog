...
export default function NewCategoryPage() {
  ...
  const handleRemoveImage = () => {
    setForm((f) => ({ ...f, coverImageFile: null }));
    setPreview(null);
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-4 sm:mb-6">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 shadow-lg">
              <FolderPlus className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
            </div>
            <div>
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900" style={{ fontFamily: 'var(--font-playfair)' }}>
                Create New Category
              </h1>
              <p className="text-xs sm:text-sm text-gray-600 mt-1">Add a new category to organize your content</p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              {!preview ? (
                ...
                <div className="relative rounded-lg sm:rounded-xl overflow-hidden border-2 border-gray-200 group">
                  ...
                  <div className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-green-500 text-white text-xs px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg font-medium flex items-center gap-1.5 shadow-lg">
        ...
        <div className="mt-4 sm:mt-6 bg-blue-50 border border-blue-200 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-1 text-sm sm:text-base">Quick Tips</h3>
              <ul className="text-xs sm:text-sm text-blue-800 space-y-1">
                <li>• Use clear, concise category names</li>
                <li>• The URL slug is automatically generated from the name</li>
                <li>• Cover images help make your categories more visually appealing</li>
