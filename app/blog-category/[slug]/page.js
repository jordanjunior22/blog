...
function CategoryPage() {
  ...
  useEffect(() => {
    async function fetchCategoryPosts() {
      try {
        const res = await fetch(`/api/posts/categories/${slug}`);
  ...
  const backgroundStyle = {
    backgroundImage: `url(${category?.coverImage || '/fallback.jpg'})`,
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <h2 className="text-lg uppercase tracking-wide text-(--cta-color)">
